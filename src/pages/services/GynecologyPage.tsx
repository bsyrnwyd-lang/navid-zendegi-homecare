...
import { Heart, CheckCircle, Phone, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 md:pt-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6">
                  مراقبت تخصصی از سلامت زنان در خصوصیت منزل. ویزیت متخصص زنان و زایمان با رعایت کامل حریم خصوصی.
                </p>
              ...
              <div className="relative">
                <img 
                  src={gynecologyImage} 
                  alt="ویزیت متخصص زنان در منزل - مراقبت تخصصی سلامت زنان"
        ...
        <section className="medical-section">
          <div className="container mx-auto">
            <h2 className="section-title text-center mb-12">خدمات متخصص زنان در منزل</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="medical-card">
                <CardContent className="p-6">
                  <Heart className="w-12 h-12 text-primary mb-4" />
                  <h3 className="text-xl font-semibold mb-3">مراقبت‌های زنانه</h3>
                  <p className="text-muted-foreground mb-4">
                    ارائه خدمات کامل بهداشت و درمان زنان
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
                      <span className="text-sm">مراقبت‌های بارداری</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
                      <span className="text-sm">اختلالات قاعدگی</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
                      <span className="text-sm">عفونت‌های زنانه</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="medical-card">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    راهنمایی و مشاوره در مسائل سلامت زنان
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
                      <span className="text-sm">مشاوره پیش از بارداری</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
                      <span className="text-sm">آموزش بهداشت</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-secondary ml-2" />
        ...
        <section className="medical-section bg-primary/5">
          <div className="container mx-auto text-center">
            <h2 className="section-title mb-6">ویزیت متخصص زنان در منزل</h2>
            <p className="text-lg text-muted-foreground mb-8">
              مراقبت تخصصی از سلامت زنان با رعایت حریم خصوصی
            </p>
            <a 
