...
const PricingPage = () => {
  ...
  const faqs = [{
    ...
    answer: "تعرفه خدمات بر اساس نوع خدمت (پرستاری، ویزیت پزشک، خدمات تخصصی)، زمان ارائه خدمت (روز یا شب) و موقعیت مکانی محاسبه می‌شود. در صورت درخواست اورژانسی یا شبانه، ۲۰ تا ۳۰ درصد به تعرفه اضافه می‌شود. برای محاسبه دقیق با شماره <a href='tel:09386117912' className='text-primary hover:underline font-semibold'>09386117912</a> تماس بگیرید."
  }, {
