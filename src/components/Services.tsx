  ...
  const services = [
    {
      ...
      description: "ویزیت متخصص قلب در منزل تهران توسط کاردیولوژیست‌های مجرب نوید زندگی با تجهیزات پیشرفته",
    ...
    },
    {
      ...
      description: "خدمات هولتر ریتم قلب و هولتر فشار خون ۲۴ ساعته در منزل با دستگاه‌های مدرن و گزارش تخصصی کاردیولوژیست",
    ...
    },
    {
      ...
      description: "ویزیت پزشک عمومی در منزل تهران توسط پزشکان مجرب نوید زندگی در محیط راحت منزل شما",
      features: ["ویزیت پزشک عمومی در منزل", "تجویز دارو و نسخه", "مشاوره پزشکی", "ارجاع به متخصص در صورت نیاز"],
      link: "/general-doctor"
    },
    {
      icon: UserCheck,
      title: "ویزیت متخصص در منزل",
      description: "ویزیت متخصص داخلی، اعصاب، ارتوپدی و سایر تخصص‌ها در منزل توسط پزشکان متخصص نوید زندگی",
      features: ["ویزیت متخصص داخلی در منزل", "ویزیت متخصص اعصاب در منزل", "ویزیت متخصص ارتوپدی", "ویزیت متخصص ریه و عفونی"],
    ...
    },
    {
      ...
      features: ["اکوکاردیوگرافی در منزل", "نوار قلب در منزل", "ارزیابی عملکرد قلب", "تفسیر توسط متخصص قلب"],
    ...
    },
    {
      ...
      features: ["مراقبت پرستاری در منزل", "پانسمان زخم در منزل", "تزریقات در منزل", "مراقبت‌های ویژه"],
