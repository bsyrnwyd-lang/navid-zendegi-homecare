...
const CaptoprilPage = lazy(() => import("./pages/articles/CaptoprilPage"));
const SystolicDiastolicPage = lazy(() => import("./pages/articles/SystolicDiastolicPage"));
const SodiumPotassiumPage = lazy(() => import("./pages/articles/SodiumPotassiumPage"));
...
const INRMonitoringPage = lazy(() => import("./pages/articles/INRMonitoringPage"));
const HeparinEnoxaparinPage = lazy(() => import("./pages/articles/HeparinEnoxaparinPage"));
const SilentHeartAttackPage = lazy(() => import("./pages/articles/SilentHeartAttackPage"));
...
const PostprandialHypotensionPage = lazy(() => import("./pages/articles/PostprandialHypotensionPage"));
const PortableDeviceAccuracyPage = lazy(() => import("./pages/articles/PortableDeviceAccuracyPage"));
const HeartValveDiseasePage = lazy(() => import("./pages/articles/HeartValveDiseasePage"));
...
const SleepApneaHeartPage = lazy(() => import("./pages/articles/SleepApneaHeartPage"));
const SupplementsHeartAthletesPage = lazy(() => import("./pages/articles/SupplementsHeartAthletesPage"));
...
const ProstateVolumePage = lazy(() => import("./pages/articles/ProstateVolumePage"));
const DrugInteractionsHeartProstatePage = lazy(() => import("./pages/articles/DrugInteractionsHeartProstatePage"));
...
const IvabradineVsBetablockerPage = lazy(() => import("./pages/articles/IvabradineVsBetablockerPage"));
const HeartFailureDrugInteractionsPage = lazy(() => import("./pages/articles/HeartFailureDrugInteractionsPage"));
const HiddenStrokeHeartAttackPage = lazy(() => import("./pages/articles/HiddenStrokeHeartAttackPage"));
const HeartStrokeRiskQuizPage = lazy(() => import("./pages/articles/HeartStrokeRiskQuizPage"));
const RepathaEvolocumabPage = lazy(() => import("./pages/articles/RepathaEvolocumabPage"));
                    ...
                    <Route path="/articles/influenza-mortality" element={<InfluenzaMortalityPage />} />
                     ...
                     <Route path="/articles/white-blood-cells" element={<WhiteBloodCellsPage />} />
                      ...
                      <Route path="/articles/specialist-home-visit" element={<SpecialistHomeVisitPage />} />
                       ...
                       <Route path="/articles/captopril" element={<CaptoprilPage />} />
                       <Route path="/articles/systolic-diastolic" element={<SystolicDiastolicPage />} />
                       <Route path="/articles/sodium-potassium" element={<SodiumPotassiumPage />} />
                       ...
                       <Route path="/articles/inr-monitoring" element={<INRMonitoringPage />} />
                       <Route path="/articles/heparin-enoxaparin" element={<HeparinEnoxaparinPage />} />
                       <Route path="/articles/silent-heart-attack" element={<SilentHeartAttackPage />} />
                       ...
                       <Route path="/articles/postprandial-hypotension" element={<PostprandialHypotensionPage />} />
                       <Route path="/articles/portable-device-accuracy" element={<PortableDeviceAccuracyPage />} />
                       <Route path="/articles/heart-valve-disease" element={<HeartValveDiseasePage />} />
                       ...
                       <Route path="/articles/sleep-apnea-heart" element={<SleepApneaHeartPage />} />
                       <Route path="/articles/supplements-heart-athletes" element={<SupplementsHeartAthletesPage />} />
                       ...
                       <Route path="/articles/prostate-volume" element={<ProstateVolumePage />} />
                       <Route path="/articles/drug-interactions-heart-prostate" element={<DrugInteractionsHeartProstatePage />} />
                       ...
                       <Route path="/articles/angiography-vs-angioplasty" element={<AngiographyVsAngioplastyPage />} />
                        ...
                        <Route path="/articles/ivabradine-vs-betablocker" element={<IvabradineVsBetablockerPage />} />
                         <Route path="/articles/heart-failure-drug-interactions" element={<HeartFailureDrugInteractionsPage />} />
                         <Route path="/articles/hidden-stroke-heart-attack-symptoms" element={<HiddenStrokeHeartAttackPage />} />
                         <Route path="/articles/heart-stroke-risk-quiz" element={<HeartStrokeRiskQuizPage />} />
                         <Route path="/articles/repatha-evolocumab" element={<RepathaEvolocumabPage />} />
